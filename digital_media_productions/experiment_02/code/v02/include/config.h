...
#define M1_MICROSTEPPING 16// Microstepping configuration motor 01 (steps multiplier)
#define M2_MICROSTEPPING 16// Microstepping configuration motor 02 (steps multiplier)
